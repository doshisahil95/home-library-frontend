      ...
      <div className="flex gap-2 items-center">
        <div className="flex-1">
          <input
            ...
            className="w-full h-10 px-4 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100"
          />
        </div>
        <button
          type="button"
        ...
        <button
          ...
          className="h-10 px-4 rounded-lg bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-100 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
        >
          Reset
        </button>
      </div>
